...
"[project]/components/HeroSlideshow.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        "HeroSlideshow.useEffect": ()=>{
            ...
            const interval = setInterval({
                "HeroSlideshow.useEffect.interval": ()=>{
                    setCurrent({
                        "HeroSlideshow.useEffect.interval": (prev)=>(prev + 1) % slides.length
                    }["HeroSlideshow.useEffect.interval"]);
                }
            }["HeroSlideshow.useEffect.interval"], 2000);
            return ({
...
_s(HeroSlideshow, "pt4h3MjmkqxSnpRXBf8s8oyypYg=");
_c = HeroSlideshow;
var _c;
...
//# sourceMappingURL=components_HeroSlideshow_tsx_7b18cb1d._.js.map